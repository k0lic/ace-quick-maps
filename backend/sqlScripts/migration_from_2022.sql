...
ADD COLUMN `room_single` VARCHAR(64) NULL DEFAULT NULL AFTER `pax_raw`,
ADD COLUMN `room_double` VARCHAR(64) NULL DEFAULT NULL AFTER `room_single`,
ADD COLUMN `room_twin` VARCHAR(64) NULL DEFAULT NULL AFTER `room_double`,
ADD COLUMN `room_triple` VARCHAR(64) NULL DEFAULT NULL AFTER `room_twin`,
ADD COLUMN `room_apt` VARCHAR(64) NULL DEFAULT NULL AFTER `room_triple`,
